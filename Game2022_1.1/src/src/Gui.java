...
public class Gui extends Application {
	...
	public void start(Stage primaryStage) {
		try {
			...
			kiste = new Image(getClass().getResourceAsStream("Image/kiste.png"),size,size,false,false);
			...
			if (GameLogic.getKiste() != null){
				fields[GameLogic.getKiste().getPosition().getX()][GameLogic.getKiste().getPosition().getY()].setGraphic(new ImageView(kiste));
			}
	...
	public static void moveChestOnScreen(pair oldpos,pair newpos)
	{
		removePlayerOnScreen(oldpos);
		placeChestOnScreen(newpos);
	}

	public static void placeChestOnScreen(pair newpos){
		Platform.runLater(() -> {
			fields[newpos.getX()][newpos.getY()].setGraphic(new ImageView(kiste));
		});
	}
	...
	public void playerMoved(int delta_x, int delta_y, String direction) {
		try {
			App.modtagPosition(delta_x, delta_y, direction);
